...
/**
 * EffectifeleveVenant9emetechnique
 *
 * @ORM\Table(name="effectifeleve_venant9emetechnique", indexes={@ORM\Index(name="FK_EffectifEleve_Venant9emeTechnique_Nomenclature_Recensement", columns={"CodeRece"})})
 * @ORM\Entity
 */
class EffectifeleveVenant9emetechnique
{
    /**
     * @var string
     *
     ...
     * @return EffectifeleveVenant9emetechnique
     */
