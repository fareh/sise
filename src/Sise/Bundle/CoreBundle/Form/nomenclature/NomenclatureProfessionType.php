...
class NomenclatureProfessionType extends AbstractType
{
    ...
    {
        $builder
            ->add('codeprof','text',array('label' => 'Code','translation_domain' => 'SiseCoreBundle'))
            ->add('libeprofar','text',array('label' => 'Libear','translation_domain' => 'SiseCoreBundle'))
            ->add('libeproffr','text',array('label' => 'Libefr','translation_domain' => 'SiseCoreBundle'))
