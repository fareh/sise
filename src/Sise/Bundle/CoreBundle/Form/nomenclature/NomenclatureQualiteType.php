...
class NomenclatureQualiteType extends AbstractType
{
    ...
    {
        $builder
            ->add('codequal','text',array('label' => 'Code','translation_domain' => 'SiseCoreBundle'))
            ->add('libequalar','text',array('label' => 'Libear','translation_domain' => 'SiseCoreBundle'))
            ->add('libequalfr','text',array('label' => 'Libefr','translation_domain' => 'SiseCoreBundle'))
