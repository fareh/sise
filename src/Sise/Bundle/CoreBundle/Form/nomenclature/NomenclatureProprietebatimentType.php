...
class NomenclatureProprietebatimentType extends AbstractType
{
    ...
    {
        $builder
            ->add('codepropbati','text',array('label' => 'Code','translation_domain' => 'SiseCoreBundle'))
            ->add('libepropbatiar','text',array('label' => 'Libear','translation_domain' => 'SiseCoreBundle'))
            ->add('libepropbatifr','text',array('label' => 'Libefr','translation_domain' => 'SiseCoreBundle'))
