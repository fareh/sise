...
class NomenclatureTypetravailType extends AbstractType
{
    ...
    {
        $builder
            ->add('codetypetrav','text',array('label' => 'Code','translation_domain' => 'SiseCoreBundle'))
            ->add('libetypetravar','text',array('label' => 'Libear','translation_domain' => 'SiseCoreBundle'))
            ->add('libetypetravfr','text',array('label' => 'Libefr','translation_domain' => 'SiseCoreBundle'))
