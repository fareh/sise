...
class NomenclatureSecteurType extends AbstractType
{
    ...
    {
        $builder
            ->add('codesect','text',array('label' => 'Code','translation_domain' => 'SiseCoreBundle'))
            ->add('libesectar','text',array('label' => 'Libear','translation_domain' => 'SiseCoreBundle'))
            ->add('libesectfr','text',array('label' => 'Libefr','translation_domain' => 'SiseCoreBundle'))
