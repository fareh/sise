...
class NomenclatureZoneType extends AbstractType
{
    ...
    {
        $builder
            ->add('codezone','text',array('label' => 'Code','translation_domain' => 'SiseCoreBundle'))
            ->add('libezonear','text',array('label' => 'Libear','translation_domain' => 'SiseCoreBundle'))
            ->add('libezonefr','text',array('label' => 'Libefr','translation_domain' => 'SiseCoreBundle'))
