    ...
    public function updateAction(Request $request, $codeetab, $codetypeetab)
    {
        ...
        if ($codeetab && $codetypeetab) {
            ...
            for ($i = 0; $i < count($entities); $i++) {
                ...
                $item->setNombelevresimasc($request->request->get('sise_bundle_corebundle_effectiveelevenouveauseptiemeannee_nombelevresimasc_' . $i));
                $item->setNombelevresifemi($request->request->get('sise_bundle_corebundle_effectiveelevenouveauseptiemeannee_nombelevresifemi_' . $i));
                $item->setNombtotaresielev($request->request->get('sise_bundle_corebundle_effectiveelevenouveauseptiemeannee_nombtotaresielev_' . $i));
                $item->setNombelevbourfemi($request->request->get('sise_bundle_corebundle_effectiveelevenouveauseptiemeannee_nombelevbourfemi_' . $i));
                $item->setNombtotabourelev($request->request->get('sise_bundle_corebundle_effectiveelevenouveauseptiemeannee_nombtotabourelev_' . $i));
                $em->persist($item);
